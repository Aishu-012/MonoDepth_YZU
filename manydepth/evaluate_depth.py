...
def evaluate(opt):
    ...
    gt_depth_resized = cv2.resize(gt_depth, (1242, 375))
    pred_depth_resized = cv2.resize(pred_depth, (1242, 375))


    plt.figure(figsize=(12, 6))
    plt.subplot(1, 2, 1)
    plt.imshow(gt_depth_resized, cmap='plasma')
    plt.title('Original Depth Map')
    plt.colorbar()
    plt.subplot(1, 2, 2)
    plt.imshow(pred_depth_resized, cmap='plasma')
